...
public class SoundDrillJsonBuilder {
    ...
    public static String getSoundDrillTenJson(Context context,
                                              ...
                                              String touchSound,
                                              ArrayList<classact.com.clever_little_monkey.database.model.Word> words){
        String drillData = "{\"instructions\":\"" + readAfterDamaSound + "\"," +
                "\"touch\":\"" +  touchSound + "\"," +
                "\"words\":[" ;
        for (int i = 0; i < words.size(); i++) {
            classact.com.clever_little_monkey.database.model.Word word = words.get(i);
    ...
    public static String getSoundDrillElevenJson(Context context,
                                                  ...
                                                  List<classact.com.clever_little_monkey.database.model.Word> words) {
    ...
    public static String getSoundDrillTwelveJson(Context context,
        ...
        for (int i = 0; i < sets.size(); i++) {
            ...
            ArrayList<DraggableImage<classact.com.clever_little_monkey.database.model.Word>> rightAndWrongWords = set.getRightAndWrongWords();

            // Populate Draggable Images (a.k.a. 'Letter Images') in word
            for (int j = 0; j < rightAndWrongWords.size(); j++) {

                DraggableImage<classact.com.clever_little_monkey.database.model.Word> theWord = rightAndWrongWords.get(j);
