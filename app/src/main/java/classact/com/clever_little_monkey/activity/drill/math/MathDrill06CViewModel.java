...
public class MathDrill06CViewModel extends DrillViewModel {

    @Inject
    public MathDrill06CViewModel(Bus bus) {
        super(bus);
    }

    @Override
    public MathDrill06CViewModel register(Lifecycle lifecycle) {
        super.register(lifecycle);
        return this;
    }

    @Override
    public MathDrill06CViewModel prepare(Context context) {
        return this;
    }
}