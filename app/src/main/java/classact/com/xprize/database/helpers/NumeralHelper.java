...
public class NumeralHelper {
    ...
    public static ArrayList getNumerals(SQLiteDatabase db, int languageID, int limit, int boyGirl){
        ArrayList numerals = new ArrayList();
    ...
    public static ArrayList getNumeralsBelowLimit(SQLiteDatabase db, int languageID, int limit,  int boyGirl){
        ArrayList numerals = new ArrayList();
    ...
    public static ArrayList getNumeralsBelowLimitRandom(SQLiteDatabase db, int languageID, int limitBelow, int limit, int numberToExclude,  int boyGirl){
        ArrayList numerals = new ArrayList();
    ...
    public static ArrayList getNumeralsBelowLimitFromZero(SQLiteDatabase db, int languageID, int limit,  int boyGirl){
        ArrayList numerals = new ArrayList();
    ...
    public static ArrayList getNumeralsBelowLimit235(SQLiteDatabase db, int languageID, int limit,  int boyGirl){
        ArrayList numerals = new ArrayList();
    ...
    public static ArrayList getNumeralsBelowLimit12358(SQLiteDatabase db, int languageID, int limit,  int boyGirl){
        ArrayList numerals = new ArrayList();
