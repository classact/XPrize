...
public class WordHelper {
    public static ArrayList<Word> getWords(SQLiteDatabase db){
        ...
        String[] columns = new String[] {"_id", "LanguageInd","WordName", "WordPicture","WordSlowSound",
                "WordSound","English"};
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                word.setWordSlowSoundURI(cursor.getString(4));
                word.setWordSoundURI(cursor.getString(5));
