 ...
 * Courtesy: https://stackoverflow.com/questions/13422673/looking-for-a-working-example-of-addtimedtextsource-for-adding-subtitle-to-a-vid
 */
public class SubtitleView extends AppCompatTextView implements Runnable{
    private static final String TAG = "SubtitleView";
    private static final boolean DEBUG = false;
    private static final int UPDATE_INTERVAL = 300;
    private LiveMediaPlayer player;
    ...
    public void setPlayer(LiveMediaPlayer player) {
        this.player = player;
    }
